    ...
    <table class="client-table">
        <thead>
            <tr>
                ...
                <th class="col-e">E-mail</th>
                <th class="col-no">Number of order</th>
                <th class="col-fav1">Most Ordered Product 1</th>
                <th class="col-fav2">Most Ordered Product 2</th>
                <th class="col-fav3">Most Ordered Product 3</th>
            </tr>
        </thead>
